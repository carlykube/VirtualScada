...
config['simiface']={
    ...
    'recipients' : [('10.128.0.1',9913)], #list of vdevs to send updates to
    'timeout' : .1 
}
config['sim_state']={
...
config['vdevs']['master'] = { 
        ...
        'points' : [
            ...
            {'name':'MstrWGasNothing2',  'typ':0, 'value':0, 'metadata':{
                ...
                'blocktype':3, 'datatype':'unsigned'}}},
            {'name':'MstrWGasPIDSetpoint',  'typ':0, 'value':10.0, 'metadata':{
                'modbus':{ 'addr':43522, 'blockname':'holdingreg',
                'blocktype':3, 'datatype':'float'}}},
            {'name':'MstrWGasPIDGain',  'typ':0, 'value':115.0, 'metadata':{
            ...
            {'name':'MstrWGasPIDResetRate',  'typ':0, 'value':0.2, 'metadata':{
                ...
                'blocktype':3, 'datatype':'float'}}},
            {'name':'MstrWGasPIDRate',  'typ':0, 'value':0.00001, 'metadata':{
        ...
        'clientifaces' : [
           {
                'name' : 'Modbus',
                'memory_model' : 'control_microsystems_old',
                'typ' : 'ModbusTCP',
                'address' : '10.128.0.1',
                'port' : 502,                
               }
...
config['vdevs']['slave'] = {
        ...
        'points' : [
            ...
            {'name':'MstrWNothing2',  'typ':0, 'value':0, 'metadata':{
                ...
                'blocktype':3, 'datatype':'uint'}}},
            {'name':'MstrWPIDSetpoint',  'typ':0, 'value':10.0, 'metadata':{
                'modbus':{ 'addr':43056, 'blockname':'holdingreg',
                'blocktype':3, 'datatype':'float'}}},
            {'name':'MstrWPIDGain',  'typ':0, 'value':115.0, 'metadata':{
            ...
            {'name':'MstrWPIDResetRate',  'typ':0, 'value':0.2, 'metadata':{
                ...
                'blocktype':3, 'datatype':'float'}}},
            {'name':'MstrWPIDRate',  'typ':0, 'value':0.00001, 'metadata':{
