...
config['simiface']={
    'typ':'udp', 
    'sport':9922, #9922-9949 are unassigned
    'recipients' : [('10.128.0.1',9923)], #list of vdevs to send updates to
    'timeout' : .1 
}
config['sim_state']={
...
config['vdevs']['master'] = { 
        ...
        'points' : [
            ...
            {'name':'MstrWGasPIDCycleTime',  'typ':0, 'value':0, 'metadata':{
                ...
                'blocktype':3, 'datatype':'unsigned'}}},
            {'name':'MstrWWater2SystemMode',  'typ':0, 'value':2, 'metadata':{
...
config['vdevs']['slave'] = {
        ...
        'points' : [
            ...
            {'name':'CalcReg3',  'typ':0, 'value':0, 'metadata':{
                ...
                'blocktype':3, 'datatype':'float'}}},
            {'name':'LevelScaledFloat',  'typ':0, 'value':0.0001, 'metadata':{
            ...
            {'name':'MstrRAlarms',  'typ':0, 'value':0, 'metadata':{
                ...
                'blocktype':3, 'datatype':'uint'}}},
            {'name':'MstrWSystemMode',  'typ':0, 'value':2, 'metadata':{
                'modbus':{ 'addr':3049, 'blockname':'holdingreg',
                'blocktype':3, 'datatype':'uint'}}},
